...
<html lang="vi">
  <head>
  <meta charset="UTF-8">
  <title>Liên hệ - Cờ Tướng</title>
<?php
include template('head.contact');
include template('ga');
?>
  </head>
  <body class="contact" data-href="/lien-he/">
<?php
          ...
          <div class="row">
            ...
            <div class="col-md-9 mb-md-0 mb-5">
              ...
              <div class="text-center text-md-left">
                <a class="btn btn-danger" onclick="validateForm();">Gửi</a>
              </div>
              <div id="status"></div>
            </div>
            <!--Grid column-->
            ...
            <div class="col-md-3 text-center">
              <ul class="list-unstyled mb-0">
                ...
                <li><i class="fas fa-envelope mt-4 fa-2x"></i>
                  <p><a href="mailto:tung.42@gmail.com">datdat813@gmail.com</a></p>
                </li>
              </ul>
            </div>
            <!--Grid column-->
